...
function Dashboard() {
  ...
  return (
    <div classNameName="flex h-mx">
      <Sidebar classNameName="">
        <a href="/">
      ...
      <div classNameName="w-full h-full p-4 h-auto pt-8">
        <div classNameName="flex justify-center m-5">
          <button
            id="defaultModalButton"
            classNameName="block text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            type="button"
            onClick={toggleModal}
          >
            Add Patient
